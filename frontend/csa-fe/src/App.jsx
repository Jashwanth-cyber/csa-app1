...
function App() {
  ...
  return (
    ...
    <Router>  
      ...
      <Route path="/admin/dashboard/courses" element={<h1>Admin Dashboard Courses</h1>} />
      <Route path="/admin/dashboard/courses/:id" element={<h1>Admin Dashboard Course Details</h1>} />
      ...
      <Route path="/user/dashboard/profile" element={<h1>User Dashboard Profile</h1>} />
      </Routes>
      </Router>
)}
